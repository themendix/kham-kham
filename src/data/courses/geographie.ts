...
export const GEOGRAPHIE_COURSES: Course[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        blocks: [
          { type: "paragraphe", text: "**Population.** L'Algérie compte environ 46 millions d'habitants (2024). La population, jeune, se concentre très largement sur la bande côtière du nord, où le climat et les terres sont plus favorables, tandis que l'immense Sahara reste peu peuplé." },
          { type: "paragraphe", text: "Cette concentration s'est encore renforcée avec l'urbanisation : la majorité des Algériens vivent désormais en ville, notamment dans l'agglomération d'Alger et sur le littoral d'Oran à Annaba. La population reste marquée par sa jeunesse, avec une part importante de moins de 30 ans, ce qui pèse sur les besoins en logement, en emploi et en éducation." },
          { type: "paragraphe", text: "**Société.** La société algérienne est composée d'Arabes et de Berbères (Kabyles, Chaouis, Mozabites, Touaregs du sud). L'arabe et le tamazight (berbère) sont langues officielles ; le français reste très présent dans l'enseignement et les affaires. L'islam sunnite est la religion de la grande majorité et la religion d'État." },
          { type: "paragraphe", text: "La Kabylie, région montagneuse à l'est d'Alger, est le principal foyer de la culture et de la langue berbères, avec une forte identité régionale. La société algérienne reste marquée par la mémoire de la guerre d'indépendance (1954-1962) et par des solidarités familiales et villageoises fortes, y compris au sein de l'importante diaspora installée en France et ailleurs en Europe." },
        ],
      },
      {
        ...
        blocks: [
          ...
          { type: "paragraphe", text: "**Institutions et politique.** Régime : république. Chef de l'État (2026) : Abdelmadjid Tebboune. Monnaie : le dinar algérien (DZD). Devise nationale : « Par le peuple et pour le peuple »." },
          { type: "paragraphe", text: "L'Algérie a accédé à l'indépendance le 5 juillet 1962, au terme d'une guerre longue et meurtrière contre la France. Elle est membre de l'Union africaine, de la Ligue arabe, de l'Union du Maghreb arabe et de l'OPEP, et joue un rôle diplomatique de premier plan sur les dossiers régionaux (Sahel, Sahara occidental)." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Alger, surnommée « Alger la Blanche », dont la vieille Casbah est classée au patrimoine mondial de l'UNESCO. Le pays conserve de superbes ruines romaines (Timgad, Djémila) et l'art rupestre du Tassili n'Ajjer en plein Sahara. L'Algérie garde une mémoire forte de sa guerre d'indépendance contre la France (1954-1962)." },
        ],
      },
    ],
    quiz: [
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** Avec plus de 110 millions d'habitants (2024), l'Égypte est le pays le plus peuplé du monde arabe et l'un des plus peuplés d'Afrique. La quasi-totalité de cette population vit entassée le long du Nil et dans le delta, sur une petite fraction du territoire." },
          { type: "paragraphe", text: "Cette densité extrême, l'une des plus fortes du monde le long d'un fleuve, s'accompagne d'une urbanisation rapide : Le Caire et sa région forment l'une des plus grandes agglomérations d'Afrique et du monde arabe, tandis qu'Alexandrie reste le grand port et la deuxième ville du pays. La population égyptienne est jeune, avec une natalité qui continue d'alimenter une forte croissance démographique." },
          { type: "paragraphe", text: "**Société.** La population est majoritairement arabe ; l'arabe est la langue officielle. L'islam sunnite est la religion dominante, aux côtés d'une importante minorité chrétienne copte, l'une des plus anciennes communautés chrétiennes du monde. Le Caire est un grand foyer culturel et religieux du monde arabe." },
          { type: "paragraphe", text: "Al-Azhar, au Caire, est l'une des plus anciennes et des plus prestigieuses institutions d'enseignement religieux sunnite au monde. La société égyptienne, très attachée à la vallée du Nil comme source de vie depuis l'Antiquité, reste également fière de sa culture populaire (cinéma, musique, presse) qui a longtemps rayonné dans tout le monde arabophone." },
        ],
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** L'économie repose sur l'agriculture du Nil (coton, riz, blé), le tourisme, les revenus du canal de Suez, le gaz naturel et les transferts d'argent des Égyptiens travaillant à l'étranger. La forte croissance démographique pèse sur l'emploi et les ressources." },
          { type: "paragraphe", text: "**Institutions et politique.** Régime : république. Chef de l'État (2026) : Abdel Fattah al-Sissi. Monnaie : la livre égyptienne (EGP). Devise nationale : l'Égypte n'a pas de devise officielle consacrée." },
          { type: "paragraphe", text: "L'Égypte est une république depuis 1953, après le renversement de la monarchie lors de la révolution de 1952. Elle est membre de la Ligue arabe, dont elle a longtemps abrité le siège au Caire, et de l'Union africaine, et a joué un rôle pivot dans la diplomatie régionale, notamment sur les dossiers israélo-arabe et libyen." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Le Caire, mégapole de la vallée du Nil (une nouvelle capitale administrative a été bâtie à l'est). L'Égypte abrite parmi les monuments les plus célèbres du monde : les pyramides de Gizeh et le Sphinx, les temples de Louxor et Karnak. Son drapeau rouge-blanc-noir porte l'aigle de Saladin." },
        ],
      },
    ],
    quiz: [
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** La Libye compte environ 7 millions d'habitants (2024), massés sur le littoral, autour de Tripoli et de Benghazi. L'immense intérieur désertique est presque vide." },
          { type: "paragraphe", text: "Cette concentration côtière fait de la Libye l'un des pays les plus urbanisés d'Afrique du Nord : la grande majorité de la population vit en ville, la vie rurale et nomade dans le Sahara ayant fortement reculé. La population reste jeune, et les années de conflit depuis 2011 ont provoqué d'importants déplacements internes vers les grandes villes côtières." },
          { type: "paragraphe", text: "**Société.** La population est en majorité arabe et berbère (Amazighs), avec des minorités touarègue et toubou dans le sud saharien. L'arabe est la langue officielle et l'islam sunnite la religion de la quasi-totalité des habitants." },
          { type: "paragraphe", text: "Les minorités berbérophones, notamment dans le Jebel Nefoussa et à Zouara, ainsi que les Touaregs et Toubous du grand sud, entretiennent des identités régionales fortes, parfois en tension avec le pouvoir central. Avant les crises des années 2010, la Libye accueillait aussi une importante population de travailleurs migrants venus d'Afrique subsaharienne et d'Égypte." },
        ],
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** L'économie libyenne dépend presque entièrement du pétrole : le pays possède parmi les plus importantes réserves d'Afrique. Cette mono-dépendance et l'instabilité politique, qui a perturbé la production, laissent peu de place à la diversification." },
          { type: "paragraphe", text: "**Institutions et politique.** Le pays est en transition depuis la chute de Mouammar Kadhafi en 2011, avec un pouvoir longtemps divisé entre l'est et l'ouest. Régime : transition politique. Chef de l'État (2026) : Mohamed al-Menfi, président du Conseil présidentiel reconnu internationalement ; Premier ministre du gouvernement d'union : Abdelhamid Dbeibah. Des élections nationales sont annoncées pour février 2027. Monnaie : le dinar libyen (LYD). Devise nationale : pas de devise officielle consacrée." },
          { type: "paragraphe", text: "Avant 2011, la Libye avait été un royaume indépendant à partir de 1951, avant de devenir en 1977 la « Jamahiriya » (l'État des masses) sous Mouammar Kadhafi. Elle est membre de l'Union africaine, de la Ligue arabe et de l'Union du Maghreb arabe." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Tripoli. La Libye conserve des sites antiques exceptionnels — les cités romaines de Leptis Magna et Sabratha, la cité grecque de Cyrène — inscrites au patrimoine mondial de l'UNESCO. Le pays reste marqué par les 42 ans de pouvoir de Kadhafi (1969-2011) et par la révolution de 2011." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        blocks: [
          ...
          { type: "paragraphe", text: "Le royaume est organisé en 12 régions administratives, de Tanger-Tétouan-Al Hoceïma au nord à Dakhla-Oued Ed-Dahab au sud. Casablanca, sur la façade atlantique, est de loin la plus grande ville et le principal port du pays, loin devant Rabat, la capitale politique." },
          { type: "paragraphe", text: "**Le milieu.** Le pays est structuré par les chaînes de l'Atlas : le Haut Atlas, avec le mont Toubkal (environ 4 167 m), plus haut sommet d'Afrique du Nord, et le Rif au nord. Entre les montagnes et l'océan s'étendent des plaines atlantiques fertiles ; le Sahara commence au sud-est. Le climat va du méditerranéen, au nord, à l'aride, au sud." },
          { type: "paragraphe", text: "Entre le Haut Atlas et l'Anti-Atlas, plus au sud, s'étendent des vallées présahariennes comme celle du Drâa, réputées pour leurs palmeraies et leurs kasbahs en pisé. Le littoral atlantique, long de plus d'un millier de kilomètres, alterne plages, falaises et grandes plaines céréalières comme la Chaouia." },
        ],
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** Le Maroc compte environ 37 millions d'habitants (2024), répartis surtout dans les plaines de l'ouest et les grandes villes du littoral atlantique." },
          { type: "paragraphe", text: "Plus de 60 % des Marocains vivent aujourd'hui en ville, une urbanisation portée par l'axe Casablanca-Rabat-Kénitra. La population reste jeune, même si la natalité a fortement baissé depuis les années 1980, et l'émigration vers l'Europe, notamment la France, l'Espagne et les Pays-Bas, a constitué depuis des décennies une importante diaspora." },
          { type: "paragraphe", text: "**Société.** La société marocaine mêle Arabes et Berbères (Amazighs). L'arabe et l'amazighe sont langues officielles ; le français reste très utilisé. L'islam sunnite est la religion d'État, le roi portant le titre de « Commandeur des croyants »." },
          { type: "paragraphe", text: "Les Berbères se répartissent en trois grandes aires linguistiques (tarifit au nord, tamazight au centre, tachelhit au sud) et représentent une part importante de la population, notamment dans les montagnes de l'Atlas et du Rif. Le pays compte aussi une petite minorité chrétienne et une communauté juive marocaine historique, aujourd'hui très réduite mais dont l'héritage culturel reste visible dans plusieurs villes." },
        ],
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** Le Maroc est le premier exportateur mondial de phosphates (via le groupe public OCP), matière première des engrais. Son économie s'appuie aussi sur l'agriculture, le tourisme, une industrie automobile et aéronautique en plein essor, le textile et la pêche." },
          { type: "paragraphe", text: "**Institutions et politique.** Régime : monarchie constitutionnelle. Chef de l'État (2026) : le Roi Mohammed VI. Monnaie : le dirham marocain (MAD). Devise nationale : « Dieu, la Patrie, le Roi »." },
          { type: "paragraphe", text: "Le Maroc est indépendant de la France et de l'Espagne depuis 1956. Membre de la Ligue arabe et de l'Union du Maghreb arabe, il a réintégré l'Union africaine en 2017 après plus de trente ans d'absence, liée au différend sur le Sahara occidental." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Rabat. Le pays est célèbre pour ses villes impériales et leurs médinas classées à l'UNESCO — Fès et Marrakech — tandis que Casablanca est le poumon économique. Son drapeau rouge porte une étoile verte à cinq branches. Artisanat, thé à la menthe et culture berbère font partie de son identité." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        title: "Le territoire",
        blocks: [
          { type: "paragraphe", text: "**Situation territoriale.** La Mauritanie se situe à la charnière du Maghreb et de l'Afrique de l'Ouest, avec une façade atlantique. Sur environ 1,03 million de km², en grande partie saharien, elle est bordée par le Sahara occidental, l'Algérie, le Mali et, au sud, le Sénégal — dont la frontière est marquée par le fleuve Sénégal." },
          { type: "paragraphe", text: "Le pays est découpé en une quinzaine de régions, dont Nouakchott, la capitale, forme à elle seule un district particulier sur la côte atlantique. La quasi-totalité de la vie économique et administrative se concentre dans cette étroite bande littorale et sahélienne du sud, tant l'intérieur saharien reste vide." },
          { type: "paragraphe", text: "**Le milieu.** Le Sahara couvre le nord et le centre du pays ; seule une frange sahélienne au sud, le long du fleuve Sénégal, permet l'agriculture. Le climat est aride et le pays est très exposé à la désertification. Sa côte atlantique, au niveau du banc d'Arguin, compte parmi les eaux les plus poissonneuses du monde." },
          { type: "paragraphe", text: "À l'intérieur des terres, le plateau de l'Adrar et les massifs du Tagant portent d'anciennes cités caravanières bâties autour d'oasis, seuls points d'eau permanents dans un océan de dunes et de regs. Le parc national du Banc d'Arguin, sur la côte, protège à la fois les eaux poissonneuses et un vaste site de reproduction pour les oiseaux migrateurs." },
        ],
      },
      {
      ...
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** L'économie repose sur le minerai de fer (principale exportation, via la SNIM), l'or et le cuivre, sur une pêche abondante et sur l'élevage. Le pays est aussi devenu producteur de gaz naturel offshore avec le champ Grand Tortue Ahmeyim (GTA), partagé avec le Sénégal." },
          { type: "paragraphe", text: "**Institutions et politique.** Régime : République islamique. Chef de l'État (2026) : Mohamed Ould Ghazouani. Monnaie : l'ouguiya (MRU). Devise nationale : « Honneur, Fraternité, Justice »." },
          { type: "paragraphe", text: "La Mauritanie est indépendante de la France depuis le 28 novembre 1960. Elle est membre de l'Union africaine et de la Ligue arabe, mais a quitté la CEDEAO en 2000 pour se rapprocher du Maghreb ; elle appartient aujourd'hui à l'Union du Maghreb arabe." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Nouakchott. La Mauritanie abrite d'anciennes villes caravanières du désert — Ouadane, Chinguetti, Tichitt et Oualata — inscrites à l'UNESCO ; Chinguetti est une ville sainte réputée pour ses bibliothèques de manuscrits. Le banc d'Arguin est un sanctuaire majeur pour les oiseaux migrateurs." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        blocks: [
          ...
          { type: "paragraphe", text: "Le pays est divisé en 18 États (wilayat), héritage d'un très vaste territoire longtemps administré depuis Khartoum. Le Darfour, à l'ouest, et le Kordofan, au centre, forment de vastes régions semi-arides longtemps marginalisées par rapport à la vallée du Nil." },
          { type: "paragraphe", text: "**Le milieu.** Le nord est désertique, le sud est une savane sahélienne ; le Nil constitue l'axe vital du pays. Le climat, aride à semi-aride, devient un peu plus humide vers le sud, où tombent les rares pluies." },
          { type: "paragraphe", text: "Au-delà du désert de Nubie au nord, le pays conserve, le long du Nil, une étroite bande cultivable héritée de la civilisation nubienne antique. Vers l'est, les monts de la mer Rouge dominent une côte aride ; vers l'ouest, le massif volcanique du Jebel Marra, au Darfour, culmine à plus de 3 000 m et constitue l'un des rares points d'eau de la région." },
        ],
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** Le Soudan compte environ 48 millions d'habitants (2024), une population lourdement affectée par la guerre, qui a provoqué depuis 2023 des déplacements massifs parmi les plus importants du monde." },
          { type: "paragraphe", text: "Avant la guerre, la population se concentrait déjà fortement le long du Nil et autour de Khartoum, la plus grande agglomération du pays ; les combats depuis 2023 ont vidé une partie de la capitale et poussé des millions de personnes vers l'est du pays, l'Égypte, le Tchad et le Soudan du Sud." },
          { type: "paragraphe", text: "**Société.** C'est une mosaïque de peuples arabes et africains : Arabes soudanais, Nubiens, Beja, populations du Darfour (Four)… L'arabe et l'anglais sont langues officielles ; l'islam est la religion majoritaire." },
          { type: "paragraphe", text: "Cette diversité ethnique, longtemps mal représentée dans le pouvoir centralisé à Khartoum, est au cœur des tensions qui ont marqué le pays depuis l'indépendance : guerre civile avec le Sud chrétien et animiste jusqu'en 2005, puis conflit du Darfour à partir de 2003, aujourd'hui guerre entre l'armée et les Forces de soutien rapide." },
        ],
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** L'agriculture est centrale : le Soudan est le premier producteur mondial de gomme arabique, en plus du sésame, du coton et du sorgho ; l'or et l'élevage complètent ses ressources. La guerre civile a toutefois dévasté l'économie." },
          { type: "paragraphe", text: "**Institutions et politique.** Le pays est sous régime militaire de transition et plongé dans une guerre civile depuis avril 2023, qui oppose l'armée régulière aux Forces de soutien rapide (FSR). Chef de l'État de facto (2026) : le général Abdel Fattah al-Burhan, président du Conseil de souveraineté (Premier ministre : Kamel Idris). Monnaie : la livre soudanaise (SDG). Devise nationale : « La victoire est à nous »." },
          { type: "paragraphe", text: "Le Soudan est indépendant du Royaume-Uni et de l'Égypte depuis le 1ᵉʳ janvier 1956. Membre de la Ligue arabe et de l'Union africaine, il a connu depuis l'indépendance une succession quasi ininterrompue de coups d'État et de guerres civiles, dont la sécession du Soudan du Sud en 2011 reste l'épisode le plus marquant." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Khartoum, à la confluence des deux Nils. Le Soudan abrite les pyramides de Méroé, héritage du royaume nubien de Koush, classées au patrimoine mondial de l'UNESCO. Le pays reste marqué par le conflit du Darfour et par la sécession du Soudan du Sud en 2011, qui lui a fait perdre l'essentiel de son pétrole." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        blocks: [
          ...
          { type: "paragraphe", text: "Le pays compte 24 gouvernorats, dont celui de Tunis, la capitale, au cœur d'une agglomération qui concentre à elle seule une part importante de la population et de la richesse nationale, loin devant les régions intérieures et le sud désertique." },
          { type: "paragraphe", text: "**Le milieu.** Le nord, prolongement de l'Atlas tellien, est montagneux et bien arrosé ; les plaines côtières, comme le Sahel tunisien, sont couvertes d'oliviers. Vers le sud apparaissent les chotts (lacs salés) puis le Sahara. Le climat passe du méditerranéen, au nord, à l'aride, au sud." },
          { type: "paragraphe", text: "Le point culminant du pays, le Jebel Chambi (environ 1 544 m), se trouve dans le centre-ouest montagneux, non loin de la frontière algérienne. Plus au sud, le chott el-Jérid, immense lac salé asséché une grande partie de l'année, annonce les premières dunes du Sahara et les oasis de Tozeur et Nefta." },
        ],
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** La Tunisie compte environ 12 millions d'habitants (2024), concentrés sur le littoral nord et est, autour de Tunis, Sfax et Sousse." },
          { type: "paragraphe", text: "Le pays est très majoritairement urbain, avec près de sept Tunisiens sur dix vivant en ville. Le grand Tunis, à lui seul, rassemble environ un quart de la population nationale, tandis que l'intérieur du pays et le sud, moins développés, connaissent un exode vers le littoral et vers l'étranger, notamment la France et l'Italie." },
          { type: "paragraphe", text: "**Société.** La population est majoritairement arabo-berbère ; l'arabe est la langue officielle et le français très répandu. L'islam sunnite domine. La Tunisie est réputée pour son Code du statut personnel (1956), particulièrement avancé sur les droits des femmes dans la région." },
          { type: "paragraphe", text: "Adopté sous la présidence de Habib Bourguiba au lendemain de l'indépendance, ce code a aboli la polygamie et instauré le divorce judiciaire, faisant longtemps de la Tunisie une référence régionale sur les droits des femmes. La société tunisienne, largement alphabétisée et scolarisée, reste marquée par un fort attachement à l'éducation." },
        ],
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** L'économie repose sur le tourisme (plages et sites antiques), le textile, l'agriculture — la Tunisie est un grand producteur d'huile d'olive, de dattes (Deglet Nour) et d'agrumes —, les phosphates et les industries manufacturières." },
          { type: "paragraphe", text: "**Institutions et politique.** Régime : république. Chef de l'État (2026) : Kaïs Saïed. Monnaie : le dinar tunisien (TND). Devise nationale : « Liberté, Ordre, Justice »." },
          { type: "paragraphe", text: "La Tunisie est indépendante de la France depuis le 20 mars 1956 ; Habib Bourguiba, premier président, proclame la république l'année suivante. Membre de la Ligue arabe et de l'Union du Maghreb arabe, elle reste, depuis 2010-2011, le seul pays du Printemps arabe à avoir engagé une transition démocratique durable, bien que le pouvoir se soit depuis reconcentré autour de la présidence." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Tunis. Le pays est riche en sites classés à l'UNESCO : l'antique Carthage, l'amphithéâtre romain d'El Jem, la ville sainte de Kairouan, sans oublier le village bleu et blanc de Sidi Bou Saïd. C'est en Tunisie qu'a débuté le Printemps arabe en 2010-2011." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        title: "Le territoire",
        blocks: [
          { type: "paragraphe", text: "**Situation territoriale.** Le Bénin est un pays d'Afrique de l'Ouest, étroit et allongé du nord au sud, avec une petite façade sur le golfe de Guinée. Sur environ 114 800 km², il est bordé par le Togo, le Nigeria, le Niger et le Burkina Faso." },
          { type: "paragraphe", text: "Le pays est découpé en douze départements, de l'Atlantique et du Littoral au sud à l'Alibori et à l'Atacora au nord. Cette forme allongée fait traverser au Bénin plusieurs zones climatiques et culturelles très différentes sur une distance nord-sud d'environ 700 km." },
          { type: "paragraphe", text: "**Le milieu.** Le paysage passe d'un sud humide (côte, lagunes, palmeraies) à un nord plus sec de savanes. Le climat est tropical. Au nord-ouest, le parc de la Pendjari est une grande réserve de faune (éléphants, lions), inscrite dans une réserve de biosphère." },
          { type: "paragraphe", text: "Le littoral, rectiligne et sableux, est doublé d'un chapelet de lagunes côtières, dont celle de Cotonou, où s'est développée la cité lacustre de Ganvié. Vers le nord, la chaîne de l'Atacora forme le relief le plus marqué du pays, à la frontière du Togo." },
        ],
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** Le Bénin compte environ 13 à 14 millions d'habitants (2024), concentrés dans le sud, autour de Cotonou et de Porto-Novo." },
          { type: "paragraphe", text: "La population est jeune et en croissance rapide, avec une urbanisation qui s'accélère le long du corridor côtier reliant Cotonou à Porto-Novo puis à Lagos, au Nigeria. Le nord du pays, plus rural, reste nettement moins peuplé que le sud." },
          { type: "paragraphe", text: "**Société.** La société réunit de nombreux peuples : Fon, Yoruba, Bariba, Adja… Le français est la langue officielle, aux côtés de langues nationales (fon, yoruba). On y pratique le christianisme, l'islam et le vaudou, religion traditionnelle née précisément dans cette région." },
          { type: "paragraphe", text: "Les Fon, majoritaires au sud, sont les héritiers directs du royaume du Dahomey ; les Yoruba, présents au sud-est, partagent une culture commune avec leurs voisins du Nigeria ; les Bariba et les Peuls dominent au nord. Le vaudou, loin d'être marginal, structure encore de nombreuses pratiques sociales et festives, notamment lors de la fête nationale qui lui est dédiée chaque 10 janvier." },
        ],
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** L'économie repose sur l'agriculture, en particulier le coton (principale exportation), l'ananas et l'anacarde. Le port de Cotonou joue un grand rôle dans le commerce régional, notamment la réexportation vers le Nigeria voisin." },
          { type: "paragraphe", text: "**Institutions et politique.** Régime : république. Chef de l'État (2026) : Romuald Wadagni, élu en avril 2026, succédant à Patrice Talon. Monnaie : le franc CFA (XOF). Devise nationale : « Fraternité, Justice, Travail »." },
          { type: "paragraphe", text: "Le Bénin est indépendant de la France depuis le 1er août 1960, sous le nom de Dahomey jusqu'en 1975. Membre de l'UEMOA et de la CEDEAO, il partage le franc CFA avec ses voisins ouest-africains francophones." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale officielle : Porto-Novo ; mais Cotonou est le siège du gouvernement et la capitale économique. Les palais royaux d'Abomey (UNESCO) rappellent le puissant royaume du Dahomey, et la cité lacustre de Ganvié est bâtie sur pilotis. Le Bénin est reconnu comme le berceau du vaudou." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        title: "Le territoire",
        blocks: [
          { type: "paragraphe", text: "**Situation territoriale.** Le Burkina Faso est un pays enclavé d'Afrique de l'Ouest, sans accès à la mer. Sur environ 274 200 km², il est entouré par le Mali, le Niger, le Bénin, le Togo, le Ghana et la Côte d'Ivoire." },
          { type: "paragraphe", text: "Le pays est organisé en treize régions administratives autour de la capitale, Ouagadougou, au centre du territoire. Son enclavement, partagé avec le Mali et le Niger, pèse lourdement sur son commerce extérieur, dépendant des ports du golfe de Guinée (Abidjan, Téma, Lomé, Cotonou) pour ses importations et exportations." },
          { type: "paragraphe", text: "**Le milieu.** C'est un vaste plateau sahélien, au climat tropical sec : le nord est aride, le sud un peu plus arrosé. Trois grands cours d'eau le traversent (le Mouhoun ou Volta noire, le Nakambé, le Nazinon). Le pays est exposé à la désertification et, depuis quelques années, à l'insécurité liée au terrorisme dans le nord." },
          { type: "paragraphe", text: "Le relief burkinabè est globalement plat, sans grand massif montagneux, dominé par un plateau latéritique peu élevé. Le sud-ouest, plus arrosé, concentre l'essentiel des terres cultivables et des réserves de faune, comme le parc national du W, partagé avec le Niger et le Bénin." },
        ],
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** Le Burkina Faso compte environ 23 millions d'habitants (2024)." },
          { type: "paragraphe", text: "La population est jeune et majoritairement rurale, même si l'insécurité dans le nord a provoqué depuis 2019 des déplacements internes massifs vers les grandes villes, en premier lieu Ouagadougou et Bobo-Dioulasso, deuxième ville du pays." },
          { type: "paragraphe", text: "**Société.** Le peuple mossi est majoritaire, aux côtés des Peuls, Gourmantché, Bobo et d'autres. Le français est officiel, le mooré très parlé. L'islam est majoritaire, avec des chrétiens et des religions traditionnelles." },
          { type: "paragraphe", text: "Les Mossis, historiquement organisés autour de royaumes dont celui de Ouagadougou, dont le souverain porte toujours le titre de Moogho Naaba, forment le socle culturel du centre du pays. Les Peuls, éleveurs souvent transhumants, et les Bobo, à l'ouest, complètent cette mosaïque, dans un pays où les identités régionales restent fortes malgré la crise sécuritaire." },
        ],
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** L'or est devenu la première exportation (le pays est l'un des grands producteurs d'Afrique), aux côtés du coton (surnommé « l'or blanc ») et de l'élevage. L'insécurité fragilise fortement l'économie." },
          ...
          { type: "paragraphe", text: "Le pays, indépendant de la France depuis le 5 août 1960 sous le nom de Haute-Volta, l'a rebaptisé Burkina Faso en 1984 sous la présidence du révolutionnaire panafricaniste Thomas Sankara, avant que celui-ci ne soit renversé et assassiné en 1987." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Ouagadougou. Le pays abrite les ruines de Loropéni (UNESCO) et accueille le FESPACO, plus grand festival de cinéma d'Afrique. Il garde la mémoire de Thomas Sankara. Le nom « Burkina Faso » signifie « la patrie des hommes intègres »." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        title: "Le territoire",
        blocks: [
          { type: "paragraphe", text: "**Situation territoriale.** Le Cap-Vert est un archipel de dix îles volcaniques au milieu de l'océan Atlantique, à environ 570 km à l'ouest du Sénégal. Petit par la taille (environ 4 000 km²), il n'a aucune frontière terrestre." },
          { type: "paragraphe", text: "L'archipel se divise en deux groupes : les îles du Vent (Barlavento) au nord, dont Santo Antão et Sal, et les îles du Sous-le-Vent (Sotavento) au sud, dont Santiago, la plus peuplée, et Fogo. Chaque île forme une petite économie et une identité culturelle propres, malgré la petite taille de l'ensemble." },
          { type: "paragraphe", text: "**Le milieu.** Les îles sont volcaniques : le Pico do Fogo, volcan encore actif, culmine à environ 2 829 m. Le climat est sec, de type sahélien océanique, et l'eau douce est rare. Certaines îles sont montagneuses (Santo Antão), d'autres plates et sableuses (Sal, Boa Vista) avec de belles plages." },
          { type: "paragraphe", text: "Cette aridité chronique, aggravée par des cycles réguliers de sécheresse, a longtemps rendu l'agriculture vivrière précaire et poussé une partie de la population à émigrer. Le relief volcanique et montagneux de certaines îles crée en revanche des microclimats plus humides en altitude, propices à de petites cultures en terrasses." },
        ],
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** Le Cap-Vert compte environ 525 000 habitants (2024) ; fait notable, sa diaspora est plus nombreuse que la population résidente." },
          { type: "paragraphe", text: "Cette diaspora, installée notamment aux États-Unis, au Portugal, en France et aux Pays-Bas, entretient des liens économiques et culturels étroits avec l'archipel, à travers les transferts d'argent et un tourisme de retour. À l'intérieur du pays, la population se concentre surtout à Praia et sur l'île de Santiago." },
          { type: "paragraphe", text: "**Société.** La population est créole, née du métissage entre Africains et Portugais. Le portugais est la langue officielle, le créole capverdien la langue du quotidien. Le christianisme est majoritaire. Le pays est célèbre pour sa musique, la morna, popularisée par Cesária Évora." },
          { type: "paragraphe", text: "Cette identité créole, forgée dès la colonisation portugaise à partir du XVe siècle par le brassage entre colons et esclaves africains, fait du Cap-Vert un cas particulier en Afrique de l'Ouest : ni tout à fait africain, ni tout à fait lusophone au sens strict, mais un carrefour culturel atlantique à part entière." },
        ],
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** Pauvre en ressources naturelles, le Cap-Vert vit surtout du tourisme (plages de Sal et Boa Vista), des services, de la pêche et des transferts d'argent de sa diaspora." },
          { type: "paragraphe", text: "**Institutions et politique.** Régime : république (démocratie stable et reconnue). Chef de l'État (2026) : le président José Maria Neves ; Premier ministre Ulisses Correia e Silva. Monnaie : l'escudo capverdien (CVE). Devise nationale : « Unité, Travail, Progrès »." },
          { type: "paragraphe", text: "Le Cap-Vert est indépendant du Portugal depuis le 5 juillet 1975. Membre de l'Union africaine et de la CEDEAO, il fait figure d'exception régionale par la stabilité de ses institutions démocratiques depuis l'instauration du multipartisme en 1990." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Praia (sur l'île de Santiago). Cidade Velha, première ville coloniale européenne bâtie sous les tropiques, est classée à l'UNESCO, tout comme la morna au patrimoine immatériel. Le volcan de Fogo est l'un des symboles de l'archipel." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        title: "Le territoire",
        blocks: [
          { type: "paragraphe", text: "**Situation territoriale.** La Côte d'Ivoire s'ouvre sur le golfe de Guinée, avec une façade atlantique au sud. Sur environ 322 500 km², elle est bordée par le Liberia, la Guinée, le Mali, le Burkina Faso et le Ghana." },
          { type: "paragraphe", text: "Le pays est organisé en treize districts et une trentaine de régions. Abidjan, sur la lagune Ébrié, en est de loin la plus grande ville et le poumon économique, tandis que Yamoussoukro, plus au centre, est la capitale politique depuis 1983." },
          { type: "paragraphe", text: "**Le milieu.** Le sud est couvert de forêt tropicale humide, le nord de savane. Le climat est équatorial au sud, plus sec au nord. Le littoral est bordé de lagunes, et les parcs de Taï et de la Comoé (UNESCO) protègent une riche biodiversité." },
          { type: "paragraphe", text: "Le relief est globalement peu élevé, à l'exception des monts Nimba et Man à l'extrême ouest, à la frontière guinéo-libérienne, qui portent une forêt montagnarde d'une grande richesse biologique. La déforestation liée à l'expansion des cultures de cacao et de café a toutefois fortement réduit le couvert forestier original du sud du pays." },
        ],
      },
      {
      ...
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** La Côte d'Ivoire est le premier producteur mondial de cacao, mais aussi un grand producteur de café, d'hévéa (caoutchouc), d'anacarde et d'huile de palme. Le port d'Abidjan et une économie diversifiée en font la puissance de l'UEMOA." },
          { type: "paragraphe", text: "**Institutions et politique.** Régime : république. Chef de l'État (2026) : Alassane Ouattara, réélu en octobre 2025 pour un quatrième mandat. Monnaie : le franc CFA (XOF). Devise nationale : « Union, Discipline, Travail »." },
          { type: "paragraphe", text: "Le pays est indépendant de la France depuis le 7 août 1960, sous la présidence fondatrice de Félix Houphouët-Boigny jusqu'en 1993. Membre de l'UEMOA et de la CEDEAO, il en est aujourd'hui la première économie francophone d'Afrique de l'Ouest." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale politique : Yamoussoukro, où se dresse la basilique Notre-Dame-de-la-Paix, l'une des plus grandes églises du monde ; Abidjan est la capitale économique. La ville historique de Grand-Bassam est classée à l'UNESCO." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        title: "Le territoire",
        blocks: [
          { type: "paragraphe", text: "**Situation territoriale.** La Gambie est le plus petit pays d'Afrique continentale (environ 11 300 km²). C'est une étroite bande de terre qui suit de part et d'autre le fleuve Gambie, presque entièrement enclavée dans le Sénégal, sauf par sa courte façade atlantique." },
          { type: "paragraphe", text: "Cette forme singulière, héritée du tracé colonial britannique calqué sur le cours du fleuve, fait de la Gambie une enclave presque totale à l'intérieur du Sénégal, avec lequel elle entretient des liens économiques et culturels très étroits malgré la frontière." },
          { type: "paragraphe", text: "**Le milieu.** Tout le pays s'organise autour du fleuve Gambie, navigable, qui en est l'axe de vie et de transport. Le climat est tropical ; on y trouve savane et mangroves le long du fleuve." },
          { type: "paragraphe", text: "Le fleuve, navigable sur presque toute sa longueur en territoire gambien, a longtemps servi de voie de pénétration commerciale vers l'intérieur du continent, d'abord pour le commerce précolonial puis pour la traite négrière. Ses rives basses, couvertes de mangroves, abritent une faune abondante, notamment des oiseaux et des primates, protégée dans plusieurs réserves." },
        ],
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** La Gambie compte environ 2,7 millions d'habitants (2024)." },
          { type: "paragraphe", text: "Malgré sa petite taille, le pays affiche l'une des densités de population les plus élevées d'Afrique continentale : la population se concentre surtout autour de l'estuaire, entre Banjul et la ville voisine de Serekunda, de loin la plus peuplée du pays." },
          { type: "paragraphe", text: "**Société.** On y trouve les mêmes peuples que dans la région : Mandingues, Peuls, Wolofs, Diolas… L'anglais est la langue officielle (ancienne colonie britannique) et l'islam est très majoritaire. Le pays est surnommé la « Smiling Coast » (la côte souriante)." },
          { type: "paragraphe", text: "Cette proximité culturelle avec le Sénégal environnant, malgré des langues coloniales différentes (anglais contre français), se traduit par une intense circulation des personnes, des biens et des familles de part et d'autre de la frontière. Le surnom de « Smiling Coast » reflète la réputation d'accueil et de convivialité du pays, un atout revendiqué pour son tourisme." },
        ],
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** L'économie repose sur l'agriculture (l'arachide est la principale exportation), la pêche et surtout le tourisme balnéaire, qui attire des Européens durant l'hiver ; les transferts de la diaspora comptent aussi." },
          { type: "paragraphe", text: "**Institutions et politique.** Régime : république. Chef de l'État (2026) : Adama Barrow, président depuis 2017. Monnaie : le dalasi (GMD). Devise nationale : « Progress, Peace, Prosperity » (Progrès, Paix, Prospérité)." },
          { type: "paragraphe", text: "La Gambie est indépendante du Royaume-Uni depuis le 18 février 1965. Membre du Commonwealth (dont elle s'est brièvement retirée entre 2013 et 2017 sous la présidence de Yahya Jammeh) et de la CEDEAO, elle reste l'un des rares pays anglophones enclavés dans un ensemble francophone." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Banjul. L'île de Kunta Kinteh (ancienne James Island, UNESCO), liée au roman Racines d'Alex Haley, rappelle la traite négrière. Les cercles mégalithiques de Sénégambie (UNESCO) sont partagés avec le Sénégal." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        title: "Le territoire",
        blocks: [
          { type: "paragraphe", text: "**Situation territoriale.** Le Ghana borde le golfe de Guinée, avec une façade atlantique au sud. Sur environ 238 500 km², il est entouré par la Côte d'Ivoire, le Burkina Faso et le Togo. Il est traversé par le méridien de Greenwich, tout près de l'équateur." },
          { type: "paragraphe", text: "Le pays est découpé en seize régions, dont celle du Grand Accra, autour de la capitale, forme le principal pôle urbain et économique du pays. Le Ghana revendique une position symbolique particulière : proche à la fois de l'équateur et du méridien d'origine, il se présente souvent comme situé « au centre du monde »." },
          { type: "paragraphe", text: "**Le milieu.** Le sud est forestier, le nord couvert de savane. Le pays abrite le lac Volta, l'un des plus grands lacs artificiels du monde, créé par le barrage d'Akosombo. Le climat est tropical." },
          { type: "paragraphe", text: "Le lac Volta, qui s'étend sur une grande partie du pays du sud au centre, fournit l'essentiel de l'électricité hydroélectrique du Ghana et sert aussi de voie de transport intérieur. Le littoral, ponctué de lagunes et d'anciens forts coloniaux, cède progressivement la place, vers l'intérieur, à la forêt puis à la savane soudanienne du nord." },
        ],
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** Le Ghana compte environ 34 millions d'habitants (2024)." },
          { type: "paragraphe", text: "La population est jeune et de plus en plus urbaine, concentrée dans le sud du pays autour d'Accra et de Kumasi, capitale historique du royaume ashanti. Le nord, plus sec et moins industrialisé, reste davantage rural et connaît une migration interne vers le sud." },
          { type: "paragraphe", text: "**Société.** Les peuples akan (Ashantis, Fantis) sont les plus nombreux, aux côtés des Ewe, Ga et Dagomba. L'anglais est la langue officielle. Le christianisme domine au sud, l'islam au nord." },
          { type: "paragraphe", text: "Le royaume ashanti, dont le souverain (l'Asantehene) conserve aujourd'hui encore un rôle cérémoniel et social important depuis son trône d'or, structure fortement l'identité culturelle du centre du pays. Le Ghana est aussi connu pour son tissu traditionnel kente, tissé à l'origine par les Ashantis et les Ewe, devenu un symbole de fierté culturelle bien au-delà de ses frontières." },
        ],
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** Le Ghana est l'un des premiers producteurs d'or d'Afrique et le deuxième producteur mondial de cacao. Il exploite aussi du pétrole offshore. Son économie est relativement diversifiée et dynamique." },
          { type: "paragraphe", text: "**Institutions et politique.** Régime : république (démocratie stable, connue pour ses alternances pacifiques). Chef de l'État (2026) : John Dramani Mahama, élu en décembre 2024. Monnaie : le cedi ghanéen (GHS). Devise nationale : « Freedom and Justice » (Liberté et Justice)." },
          { type: "paragraphe", text: "Le Ghana, ancienne colonie britannique de la « Gold Coast », est indépendant depuis le 6 mars 1957 sous la direction de Kwame Nkrumah, figure majeure du panafricanisme et premier président du pays. Membre fondateur de l'Union africaine (alors OUA, fondée en 1963) et de la CEDEAO, il est aujourd'hui considéré comme l'une des démocraties les plus stables du continent." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Accra. Les forts et châteaux de la traite négrière (Cape Coast, Elmina) sont classés à l'UNESCO. Le Ghana est l'héritier de l'empire ashanti et fut, avec Kwame Nkrumah, le premier pays d'Afrique subsaharienne à devenir indépendant, en 1957." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        title: "Le territoire",
        blocks: [
          { type: "paragraphe", text: "**Situation territoriale.** La Guinée (Guinée-Conakry) donne sur l'océan Atlantique. Sur environ 246 000 km², elle est bordée par la Guinée-Bissau, le Sénégal, le Mali, la Côte d'Ivoire, le Liberia et la Sierra Leone." },
          { type: "paragraphe", text: "Le pays est découpé en huit régions administratives autour de la capitale, Conakry, bâtie sur une presqu'île de la côte atlantique. Sa forme en croissant, de la côte au Fouta-Djalon puis à la Haute-Guinée intérieure, en fait un carrefour entre plusieurs aires géographiques ouest-africaines." },
          { type: "paragraphe", text: "**Le milieu.** Le pays se divise en quatre régions naturelles : la Basse-Guinée côtière, la Moyenne-Guinée du Fouta-Djalon, la Haute-Guinée de savane et la Guinée forestière. Le massif du Fouta-Djalon est le « château d'eau » de l'Afrique de l'Ouest : c'est là que naissent le Niger, le Sénégal et la Gambie. Le climat est tropical humide." },
          { type: "paragraphe", text: "La Guinée forestière, au sud-est, prolonge la forêt guinéenne partagée avec le Liberia et la Côte d'Ivoire, l'un des points chauds de biodiversité les plus riches d'Afrique de l'Ouest. Le mont Nimba, à cheval sur les trois pays, en est le sommet emblématique et un site UNESCO." },
        ],
      },
      {
      ...
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** La Guinée détient les plus grandes réserves mondiales de bauxite (minerai de l'aluminium) et en est un premier exportateur. Elle possède aussi de l'or, du diamant et d'énormes gisements de fer (mont Simandou), ainsi qu'un fort potentiel hydroélectrique." },
          { type: "paragraphe", text: "**Institutions et politique.** Régime : république (Ve République). Chef de l'État (2026) : le général Mamadi Doumbouya, arrivé au pouvoir par un coup d'État en 2021, puis élu président en décembre 2025 et investi en janvier 2026. Monnaie : le franc guinéen (GNF). Devise nationale : « Travail, Justice, Solidarité »." },
          { type: "paragraphe", text: "La Guinée est indépendante de la France depuis le 2 octobre 1958, seul territoire de l'Afrique-Occidentale française à avoir voté « non » au référendum proposé par le général de Gaulle, sous l'impulsion de Sékou Touré, qui en devint le premier président. Membre de l'Union africaine et de la CEDEAO, le pays a depuis connu plusieurs coups d'État." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Conakry. Le massif du Fouta-Djalon et la réserve du mont Nimba (UNESCO, à la frontière) sont des joyaux naturels. La Guinée est la patrie de Sékou Touré, qui dit « non » à la France en 1958 pour obtenir l'indépendance immédiate." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        title: "Le territoire",
        blocks: [
          { type: "paragraphe", text: "**Situation territoriale.** La Guinée-Bissau borde l'Atlantique, en Afrique de l'Ouest. Sur environ 36 100 km², elle est encadrée par le Sénégal au nord et la Guinée au sud-est, et comprend l'archipel des Bijagós (une trentaine d'îles)." },
          { type: "paragraphe", text: "C'est l'un des plus petits pays du continent, découpé en huit régions et un secteur autonome autour de Bissau, la capitale. Sa taille modeste et son relief très bas en font un pays particulièrement exposé à la montée du niveau de la mer." },
          { type: "paragraphe", text: "**Le milieu.** La côte est très découpée, faite d'estuaires et de mangroves, sur des terres basses. L'archipel des Bijagós, réserve de biosphère de l'UNESCO, abrite une faune remarquable (dont des hippopotames marins). Le climat est tropical humide." },
          { type: "paragraphe", text: "Les mangroves et les rizières côtières occupent une place centrale dans le paysage et dans l'économie vivrière du pays. Les îles Bijagós, difficiles d'accès, ont conservé des pratiques traditionnelles fortes et une biodiversité marine remarquable, notamment des tortues de mer et des lamantins." },
        ],
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** La Guinée-Bissau compte environ 2,1 millions d'habitants (2024)." },
          { type: "paragraphe", text: "La population reste majoritairement rurale, concentrée sur le continent plutôt que sur les îles Bijagós, peu peuplées. Bissau, la capitale, concentre l'essentiel de l'activité urbaine et administrative du pays." },
          { type: "paragraphe", text: "**Société.** On y trouve les peuples balante, peul, mandingue, papel… Le portugais est la langue officielle, mais le créole bissau-guinéen est le plus parlé (ancienne colonie portugaise). Islam, religions traditionnelles et christianisme cohabitent." },
          { type: "paragraphe", text: "Les Balantes, principal groupe du pays, sont surtout riziculteurs et pratiquent largement des religions traditionnelles ; les Peuls et Mandingues du nord et de l'est sont majoritairement musulmans. Cette diversité ethnique et religieuse cohabite dans un pays où l'armée a longtemps joué un rôle politique central, à l'origine d'une instabilité chronique depuis l'indépendance." },
        ],
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** L'économie repose sur l'agriculture, surtout la noix de cajou (anacarde), première exportation dont le pays est l'un des plus gros producteurs, ainsi que la pêche et le riz. C'est l'une des économies les plus pauvres, fragilisée par l'instabilité et le narcotrafic." },
          { type: "paragraphe", text: "**Institutions et politique.** Régime : transition, à la suite du coup d'État de novembre 2025. Chef de l'État (2026) : le général Horta N'Tam, président de la transition (investi en novembre 2025 après la destitution d'Umaro Sissoco Embaló) ; des élections sont annoncées pour décembre 2026. Monnaie : le franc CFA (XOF). Devise nationale : « Unité, Lutte, Progrès »." },
          { type: "paragraphe", text: "La Guinée-Bissau est indépendante du Portugal depuis le 24 septembre 1973 (reconnue en 1974), au terme d'une guerre de libération menée par Amílcar Cabral, assassiné peu avant. Membre de l'Union africaine et de la CEDEAO, le pays a connu depuis l'indépendance de très nombreux coups d'État et tentatives de coups d'État." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Bissau. L'archipel des Bijagós est le grand trésor naturel du pays. La Guinée-Bissau garde la mémoire de la lutte de libération menée par Amílcar Cabral contre le Portugal." },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        title: "Le territoire",
        blocks: [
          { type: "paragraphe", text: "**Situation territoriale.** Le Togo est un pays étroit et allongé du nord au sud, avec une courte façade sur le golfe de Guinée. Sur environ 56 800 km², il est bordé par le Ghana, le Bénin et le Burkina Faso." },
          { type: "paragraphe", text: "Le pays est découpé en cinq régions, de la région Maritime au sud, autour de Lomé, la capitale, à la région des Savanes au nord, à la frontière du Burkina Faso. Cette forme allongée, comparable à celle du Bénin voisin, fait traverser au pays plusieurs zones climatiques sur une distance nord-sud d'environ 600 km." },
          { type: "paragraphe", text: "**Le milieu.** Du sud (littoral, lagunes, plateaux) au nord (savanes), le pays est traversé en diagonale par la chaîne de l'Atakora. Le climat est tropical ; le lac Togo borde le littoral." },
          { type: "paragraphe", text: "La chaîne de l'Atakora, appelée localement monts Togo, culmine au pic d'Agou, point culminant du pays à un peu plus de 980 m, dans une région de plateaux frais propice à la culture du café et du cacao. Plus au nord, la savane cède la place à un paysage plus sec, proche de celui du Sahel." },
        ],
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** Le Togo compte environ 9 millions d'habitants (2024)." },
          { type: "paragraphe", text: "La population se concentre dans le sud, autour de Lomé et des plateaux agricoles, tandis que le nord, plus sec et plus enclavé, reste davantage rural et moins densément peuplé." },
          { type: "paragraphe", text: "**Société.** Les principaux peuples sont les Éwés (sud) et les Kabyè (nord), aux côtés des Tem et d'autres. Le français est la langue officielle. Religions traditionnelles (vaudou), christianisme et islam cohabitent." },
          { type: "paragraphe", text: "Cette distinction régionale entre Éwés du sud, plus urbanisés et christianisés, et Kabyè du nord, dont sont originaires les dirigeants du pays depuis 1967, a longtemps structuré la vie politique togolaise et alimenté des tensions autour de la répartition du pouvoir." },
        ],
      },
      {
    ...
    lessons: [
      {
        ...
        blocks: [
          ...
          { type: "paragraphe", text: "Le pays est découpé en douze départements, entre Brazzaville, la capitale politique à l'intérieur des terres, et Pointe-Noire, le grand port pétrolier sur la façade atlantique, reliées par un axe ferroviaire historique." },
          { type: "paragraphe", text: "**Le milieu.** Le pays est couvert d'une vaste forêt équatoriale (bassin du Congo, deuxième poumon vert de la planète), avec des plaines côtières et des savanes. Le fleuve Congo et son affluent l'Oubangui le bordent à l'est. Le climat est équatorial humide." },
          { type: "paragraphe", text: "Le nord du pays, autour du parc national d'Odzala-Kokoua, prolonge le grand massif forestier du bassin du Congo et abrite une faune exceptionnelle de gorilles de plaine et d'éléphants de forêt. Entre Brazzaville et la côte s'étend le Pool, une région de savanes et de plateaux qui tranche avec la forêt dominante ailleurs dans le pays." },
        ],
      },
      {
        ...
        title: "Population et société",
        blocks: [
          { type: "paragraphe", text: "**Population.** Le Congo compte environ 6 millions d'habitants (2024), fortement urbanisés à Brazzaville et Pointe-Noire." },
          { type: "paragraphe", text: "C'est l'un des pays les plus urbanisés d'Afrique subsaharienne : la grande majorité de la population vit en ville, l'essentiel des terres forestières et rurales restant très peu peuplé, à l'exception de quelques zones agricoles autour des grands axes de communication." },
          { type: "paragraphe", text: "**Société.** Les peuples Kongo, Téké et Mbochi sont les plus nombreux. Le français est officiel, le lingala et le kituba sont des langues nationales. Le christianisme est majoritaire." },
          { type: "paragraphe", text: "Les Kongo, présents dans le sud autour de Brazzaville et Pointe-Noire, les Téké, autour du Pool, et les Mbochi, dans le nord, forment les trois grands ensembles régionaux du pays, dont l'équilibre politique reste un enjeu sensible depuis l'indépendance." },
        ],
      },
      {
        ...
        title: "Économie, politique et repères",
        blocks: [
          { type: "paragraphe", text: "**Économie et ressources.** L'économie repose largement sur le pétrole offshore, principale exportation, complété par le bois. Cette dépendance au pétrole fragilise les finances du pays." },
          { type: "paragraphe", text: "**Institutions et politique.** Régime : république. Chef de l'État (2026) : Denis Sassou Nguesso, réélu en mars 2026 pour un cinquième mandat, au pouvoir sur la plupart des décennies depuis 1979. Monnaie : le franc CFA d'Afrique centrale (XAF). Devise nationale : « Unité, Travail, Progrès »." },
          { type: "paragraphe", text: "Le pays est indépendant de la France depuis le 15 août 1960. Membre de l'Union africaine et de la CEMAC, il a connu plusieurs guerres civiles dans les années 1990, avant un retour au pouvoir de Denis Sassou Nguesso qui le dirige depuis, avec une brève interruption, depuis 1979." },
          { type: "paragraphe", text: "**Repères et singularités.** Capitale : Brazzaville (face à Kinshasa). Pointe-Noire est le grand port pétrolier. Le parc national d'Odzala et la forêt du bassin du Congo abritent une faune remarquable (gorilles, éléphants de forêt)." },
        ],
      },
    ],
    quiz: [
